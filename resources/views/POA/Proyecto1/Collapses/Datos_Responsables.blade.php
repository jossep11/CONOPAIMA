...
{{-- Show the last insertion of the General Obj --}}
 ...
 @foreach ($ObjGeneralProy as $key=> $objetivo)
        ...
        @endif        
 @endforeach                   
 {{-- if cuenta==0 so if is the first one, the textarea will be empty so this is gonna be the one which is gonna be displayed --}}
 @if($cuenta==0)
